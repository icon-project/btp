...
contract('As a user, I want to send ERC20_ICX to ICON blockchain', (accounts) => {
    ...
    it('Scenario 8: User sends a valid transferring request', async () => {
        ...
        let amount = 600000;
        //funding account 1 with some ERC20_ICX tokens
        const data1 = await bsh_core.contract.methods["transfer(address,uint256)"]("0x2BB06D5F4cF1740C96BD1f77316aE89Dca704140", web3.utils.toWei("1","ether")).encodeABI();
        console.log(data1)
        ...
        const data = await bsh_core.contract.methods["transferWrappedCoin(string,uint256,string)"](_tokenName, amount, _to).encodeABI();
