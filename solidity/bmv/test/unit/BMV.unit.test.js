...
contract('BMV unit tests', async () => {
    ...
    const encodedValidators = rlp.encode(validatorsList.map(validator => validator.replace('hx', '0x00')));
    ...
    it('should get list of validators and hash of RLP encode from given list', async () => {
    ...
    it('should revert if both block updates and block proofs are empty', async () => {
        const blockUpdates = [];
    ...
    it('should revert if prev hash in block update does\'t match last block hash in MTA', async () => {
        const blockUpdate = [
            convertEthRlpToIconRlp(
                rlp.encode(
                    [ // Block header
    ...
    it('should revert if height in block update is higher than MTA\'s current height', async () => {
        const blockUpdate = [
            convertEthRlpToIconRlp(
                rlp.encode(
                    [ // Block header
    ...
    it('should revert if height in block update is lower than MTA\'s current height', async () => {
        const blockUpdate = [
            convertEthRlpToIconRlp(
                rlp.encode(
                    [ // Block header
    ...
    it('should verify relay message with block proof', async () => {
    ...
    it('should revert if block witness is empty', async () => {
        // add block #21171 to MTA
        await bmv.setMTAHeight(initOffset - 1);
        await bmv.addRootToMTA('0xe2ea2b413a46c6f35165faad7d570899d4deeb3658c19a04596d42d5473456eb');
    ...
    it('should revert if block header height in block proof is higher than MTA\'s height', async () => {
        // add block #21171 to MTA
        await bmv.setMTAHeight(initOffset - 1);
        await bmv.addRootToMTA('0xe2ea2b413a46c6f35165faad7d570899d4deeb3658c19a04596d42d5473456eb');
    ...
    it('should upgrade BMV and DataValidator', async () => {
    ...
    it('should revert if next validators are invalid', async () => {
        const validatorsList = [
            'hxb6b5791be0b5ef67063b3c10b840fb81514db2fd'
        ];
    ...
    it('should revert if votes are invalid', async () => {    
        const blockUpdate = [
            convertEthRlpToIconRlp(
                rlp.encode(
                    [ // Block header
    ...
    it('should revert if sequence number of  BTP message is higher or lower than expected', async () => {
        const blockUpdate = [
            convertEthRlpToIconRlp(
                rlp.encode(
                    [ // Block header
