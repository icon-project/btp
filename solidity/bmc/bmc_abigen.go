...
func (_BMC *BMCCaller) TryDecodeBTPMessage(opts *bind.CallOpts, _rlp []byte) (TypesBTPMessage, error) {
	var out []interface{}
	err := _BMC.contract.Call(opts, &out, "tryDecodeBTPMessage", _rlp)

	if err != nil {
		return *new(TypesBTPMessage), err
	}

	out0 := *abi.ConvertType(out[0], new(TypesBTPMessage)).(*TypesBTPMessage)
...
//
// Solidity: function tryDecodeBTPMessage(bytes _rlp) pure returns((string,string,string,int256,bytes))
func (_BMC *BMCSession) TryDecodeBTPMessage(_rlp []byte) (TypesBTPMessage, error) {
...
//
// Solidity: function tryDecodeBTPMessage(bytes _rlp) pure returns((string,string,string,int256,bytes))
func (_BMC *BMCCallerSession) TryDecodeBTPMessage(_rlp []byte) (TypesBTPMessage, error) {
	return _BMC.Contract.TryDecodeBTPMessage(&_BMC.CallOpts, _rlp)
}

// DropMessage is a paid mutator transaction binding the contract method 0xcf9260a0.
//
// Solidity: function dropMessage(string _src, string _link, uint256 _seq, string _svc, uint256 _sn, uint256 _txSeq) returns()
func (_BMC *BMCTransactor) DropMessage(opts *bind.TransactOpts, _src string, _link string, _seq *big.Int, _svc string, _sn *big.Int, _txSeq *big.Int) (*types.Transaction, error) {
	return _BMC.contract.Transact(opts, "dropMessage", _src, _link, _seq, _svc, _sn, _txSeq)
}

// DropMessage is a paid mutator transaction binding the contract method 0xcf9260a0.
//
// Solidity: function dropMessage(string _src, string _link, uint256 _seq, string _svc, uint256 _sn, uint256 _txSeq) returns()
func (_BMC *BMCSession) DropMessage(_src string, _link string, _seq *big.Int, _svc string, _sn *big.Int, _txSeq *big.Int) (*types.Transaction, error) {
	return _BMC.Contract.DropMessage(&_BMC.TransactOpts, _src, _link, _seq, _svc, _sn, _txSeq)
}

// DropMessage is a paid mutator transaction binding the contract method 0xcf9260a0.
//
// Solidity: function dropMessage(string _src, string _link, uint256 _seq, string _svc, uint256 _sn, uint256 _txSeq) returns()
func (_BMC *BMCTransactorSession) DropMessage(_src string, _link string, _seq *big.Int, _svc string, _sn *big.Int, _txSeq *big.Int) (*types.Transaction, error) {
	return _BMC.Contract.DropMessage(&_BMC.TransactOpts, _src, _link, _seq, _svc, _sn, _txSeq)
}
...
// SendInternal is a paid mutator transaction binding the contract method 0x2f3607e1.
//
// Solidity: function sendInternal(string _next, uint256 _seq, bytes _msg) returns()
func (_BMC *BMCTransactor) SendInternal(opts *bind.TransactOpts, _next string, _seq *big.Int, _msg []byte) (*types.Transaction, error) {
	return _BMC.contract.Transact(opts, "sendInternal", _next, _seq, _msg)
}

// SendInternal is a paid mutator transaction binding the contract method 0x2f3607e1.
//
// Solidity: function sendInternal(string _next, uint256 _seq, bytes _msg) returns()
func (_BMC *BMCSession) SendInternal(_next string, _seq *big.Int, _msg []byte) (*types.Transaction, error) {
	return _BMC.Contract.SendInternal(&_BMC.TransactOpts, _next, _seq, _msg)
}

// SendInternal is a paid mutator transaction binding the contract method 0x2f3607e1.
//
// Solidity: function sendInternal(string _next, uint256 _seq, bytes _msg) returns()
func (_BMC *BMCTransactorSession) SendInternal(_next string, _seq *big.Int, _msg []byte) (*types.Transaction, error) {
	return _BMC.Contract.SendInternal(&_BMC.TransactOpts, _next, _seq, _msg)
}
...
// FilterMessageDropped is a free log retrieval operation binding the contract event 0xc1d023d5ad642a07e1fb984c869d28f002b8577e6ea6d9a651ef6eacf1549e55.
//
// Solidity: event MessageDropped(string _link, uint256 _seq, bytes _msg)
...
// WatchMessageDropped is a free log subscription operation binding the contract event 0xc1d023d5ad642a07e1fb984c869d28f002b8577e6ea6d9a651ef6eacf1549e55.
//
// Solidity: event MessageDropped(string _link, uint256 _seq, bytes _msg)
...
// ParseMessageDropped is a log parse operation binding the contract event 0xc1d023d5ad642a07e1fb984c869d28f002b8577e6ea6d9a651ef6eacf1549e55.
//
// Solidity: event MessageDropped(string _link, uint256 _seq, bytes _msg)
