...
import (
	...
	account "github.com/icon-project/btp/cmd/btpsimple/module/near/account"
...
type Api interface {
	...
	getBmcLinkStatus(accountId string, link *base.BtpAddress) (types.BmcStatus, error)
...
func (c *Client) GetBlockHeader(height int64) (*base.BlockHeader, error) {
...
func (c *Client) CreateTransaction(wallet base.Wallet, p *base.TransactionParam) error {
	if nearWallet, Ok := (wallet).(*w.NearWallet); Ok {
		...
		if transactionParam, ok := (*p).(*types.TransactionParam); ok {
			...
			newTransactionParam := base.TransactionParam(transacparm)
...
func (c *Client) SignTransaction(param *base.TransactionParam) error {
...
func (c *Client) CreateSignatureTransaction(param *base.TransactionParam, transaction *Transaction) (*SignedTransaction, error) {
...
//async transaction
func (c *Client) SendTransactionAndWait(param *base.TransactionParam) ([]byte, error) {
	var result []byte
...
// func (c *Client) GetTransactionResultWithRecipts(param *base.GetResultParam) (base.TransactionResult, error) {
// 	if transactionHashParam, Ok := (*param).(*base.TransactionHashParam); Ok {
// 		if newResultParam, Ok := (*transactionHashParam).(GetResultParam); Ok {
...
func (c *Client) GetBMCLinkStatus(destination, source base.BtpAddress) (*base.BMCLinkStatus, error) {
...
func (c *Client) getEvents(accountId string, blockId int64) ([]*base.Event, []types.CryptoHash, error) {
	var events = make([]*base.Event, 0)
...
func (c *Client) BMCRelayMethodTransactionParam(wallet base.Wallet, destination base.BtpAddress, previous string, relayMessage *base.RelayMessageClient, stepLimit int64) (base.TransactionParam, error) {
...
func (c *Client) GetEventRequest(source base.BtpAddress, destination base.BtpAddress, height int64) *base.BlockRequest {
...
func (c *Client) GetReceiptProofs(blockRequest *base.BlockRequest) ([]*base.ReceiptProof, error) {
		...
		if len(events) > 0 {
			...
			for index, event := range events {
				...
				if len(receiptProof.Events) > 0 {
					...
					receiptProof.EventProofs = append(receiptProof.EventProofs, &base.EventProof{
						Proof: proof,
					})
				}
			}
