...
func (s *SimpleChain) blockProofAt(height, at int64, header []byte) (*module.BlockProof, error) {
...
func (s *SimpleChain) blockProof(height int64, header []byte) (*module.BlockProof, error) {
