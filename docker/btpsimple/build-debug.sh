...
build_image() {
    ...
    mkdir -p ${BUILD_DIR}/dist/debug/
    cp ${BASE_DIR}/../../go.mod ${BUILD_DIR}/dist/debug/
    cp ${BASE_DIR}/../../go.sum ${BUILD_DIR}/dist/debug/
    cp ${BASE_DIR}/run ${BUILD_DIR}/dist/debug/
    ...
    docker build \
        ...
        --build-arg BASE_IMAGE="${BASE_IMAGE:-golang:alpine}" \
