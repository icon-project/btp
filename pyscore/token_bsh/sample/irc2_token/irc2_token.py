...
class IRC2Token(IconScoreBase, TokenStandard):
    _NAME = 'token_name'
    ...
    def on_install(self, _name: str, _symbol: str, _decimals: int, _initialSupply: int, _owner: Address = None) -> None:
        super().on_install()
        ...
        self._balances[self.msg.sender if _owner is None else _owner] = total_supply
