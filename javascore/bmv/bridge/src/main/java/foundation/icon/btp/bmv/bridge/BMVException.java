...
public class BMVException extends BTPException.BMV {
    ...
    public static BMVException notVerifiableYet() {
        return new BMVException(Code.NotVerifiableYet);
    }

    public static BMVException notVerifiableYet(String message) {
        return new BMVException(Code.NotVerifiableYet, message);
    }

    public static BMVException alreadyVerified() {
        return new BMVException(Code.AlreadyVerified);
    }
