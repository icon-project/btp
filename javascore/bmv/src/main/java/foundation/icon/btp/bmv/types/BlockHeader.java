...
public class BlockHeader {
    ...
    public boolean verifyValidatorSignature(byte[] blockHeader) {
        ...
        /*try {
            ...
            byte[] modifiedExtraData = ExtraDataTypeDecoder.getBytes(0, getExtraData().length - 65);

            byte[] signature = ExtraDataTypeDecoder.getBytes(32, 65); // 32(offset of vanity data) + 65(signature bytes)
            ...
            boolean result = Context.verifySignature("ecdsa-secp256k1", signedBH, signature, publicKey);
