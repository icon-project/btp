...
import foundation.icon.btp.bmv.types.BlockProof;
import foundation.icon.btp.bmv.types.BlockUpdate;
...
public class BMVTest extends TestBase {
    ...
    public void should_throwError_when_invalidReceiptProofSequence(int offset) {
        String evmHeader = "";
        byte[] headerBytes58 = Hex.decode("");
        ...
        blockUpdateWriter57.beginList(4);
        blockUpdateWriter57.write(headerBytes58);
        blockUpdateWriter57.writeNull();
        blockUpdateWriter57.write(Hex.decode(evmHeader));
        blockUpdateWriter57.end();
    ...
    public void should_handleRelayMessage_when_validReceiptProof(int offset) {
        var msg = "-QoC-Qn8uQT--QT7uQJf-QJcoP6UADKvw3A2bJ_Nq-PEjs-LfDyje5C0KUsHwGilh2z9oB3MTejex116q4W1Z7bM1BrTEkUblIp0E_ChQv1A1JNHlEiUgpfDI27D6myV9O7CL9sYJV5VoA97Mj5x1abCNBeFJrMv0eIFY1lAZWw03RFoCYJ3r0HKoIOoBFPSoOWjctFh2plH321XLPcz2r7OsjRf85Tzdv-BoPspqHlcXb0Zk1Zxz-C3PnIR9KlAi-_44PcrZy3Ad4Crv8kNsDul_6CCaKSwsnJgkzc6sQ5C1oLCejyT5L4qW6clmAKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIgAAAAAAAAAALh4TRvmTw6aRmwuZqU0M5KBkng-Kfj6Ib6yEzSZte93D2AAAADo1KUQAJkwiqNlxAVUvImYKvUF2F2pUlFEXV3Uqbs33SWE_ZLTAAAA6NSlEAABd2kg_wsPONeM-VwDPCGt9wRXhRFOOSp1RBeWUuCmEgAAAOjUpRAAuQIc-QIZYaD-lAAyr8NwNmyfzavjxI7Pi3w8o3uQtClLB8BopYds_aAdzE3o3sddequFtWe2zNQa0xJFG5SKdBPwoUL9QNSTR5RIlIKXwyNuw-pslfTuwi_bGCVeVaAPezI-cdWmwjQXhSazL9HiBWNZQGVsNN0RaAmCd69ByqCDqART0qDlo3LRYdqZR99tVyz3M9q-zrI0X_OU83b_gaD7Kah5XF29GZNWcc_gtz5yEfSpQIvte2Y__QIMg0VCioRhboxmoNiDAQAGhGdldGiIZ28xLjE2LjaFbGludXgAAAARwKqeoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAiAAAAAAAAAAAuQT4-QT1uQJc-QJZoG_NOjt3fOB3IhlGfZjYwG2SM7dlIqp4_xj4ofW7fhivoB3MTejex116q4W1Z7bM1BrTEkUblIp0E_ChQv1A1JNHlEiUgpfDI27D6myV9O7CL9sYJV5VoA97Mj5x1abCNBeFJrMv0eIFY1lAZWw03RFoCYJ3r0HKoFboHxcbzFWm_4NF5pLA-G5bSOAbmWytwAFiL7XjY7QhoFboHxcbzFWm_4NF5pLA-_4A1sqlSB-nGecxG4P528OK2NW8rmFC3IAaAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIgAAAAAAAAAALh4TRvmTw6aRmwuZqU0M5KBkng-Kfj6Ib6yEzSZte93D2AAAADo1KUQAJkwiqNlxAVUvImYKvUF2F2pUlFEXV3Uqbs33SWE_ZLTAAAA6NSlEAABd2kg_wsPONeM-VwDPCGt9wRXhRFOOSp1RBeWUuCmEgAAAOjUpRAAuQIZ-QIWYaBvzTo7d3zgdyIZRn2Y2MBtkjO3ZSKqeP8Y-KH1u34Yr6AdzE3o3sddequFtWe2zNQa0xJFG5SKdBPwoUL9QNSTR5RIlIKXwyNuw-pslfTuwi_bGCVeVaAPezI-cdWmwjQXhSazL9HiBWNZQGVsNN0RaAmCd69ByqBW6B8XG8xVpv-DReaSwPhuW0jgG5lsrcABYi-142O0IaBW6B8XG8xVpv-DReaSwPhuW0jgG5lsrcABYi-_AULgIRhboxpoNiDAQAGhGdldGiIZ28xLjE2LjaFbGludXgAAAARwKqeoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAiAAAAAAAAAAA-ADA";
