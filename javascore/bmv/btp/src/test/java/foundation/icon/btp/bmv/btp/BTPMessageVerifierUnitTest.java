...
public class BTPMessageVerifierUnitTest extends TestBase {
    ...
    static final List<String> SUCCESSFUL_RELAY_MESSAGE1 = List.of(
    ...
    static final List<String[]> SUCCESSFUL_MESSAGES1 = List.of(
            new String[]{"dog"},
    ...
    static final List<String> SUCCESSFUL_RELAY_MESSAGE2 = List.of(
    ...
    static final List<String[]> SUCCESSFUL_MESSAGES2 = List.of(
    ...
    @Test
    public void successfulCases() throws Exception {
        successfulCase(SUCCESSFUL_RELAY_MESSAGE1, SUCCESSFUL_MESSAGES1);
        successfulCase(SUCCESSFUL_RELAY_MESSAGE2, SUCCESSFUL_MESSAGES2);
    }

    private void successfulCase(List<String> relayMessages, List<String[]> messages) throws Exception {
