...
public class NewAuthoritiesProof {
    ...
    public NewAuthoritiesProof(List<byte[]> newValidators) {
        ...
        ScaleWriter.writeCompactUint(eventLeafNode, 37 + 3 + newValidators.size()*(32 + 8) + 1 + (newValidators.size() > 63 ? 2: 1));
        ...
        eventLeafNode.addMany(HexConverter.hexStringToByteArray("010a00")); // new authorities event phase, index
