...
//
//public class BTPMessageCenter_temp implements BMC, BMCEvent, ICONSpecific, OwnerManager {
//    private static final Logger logger = Logger.getLogger(BTPMessageCenter_temp.class);
//
...
//
//        BMVScoreInterface verifier = getVerifier(link.getAddr().net());
//        Context.println("kwon : verifier.");
//        BMVStatusDebug prevStatus = verifier.getStatus(BMVStatusDebug.class);
//        Context.println("kwon : verifier. after");
//        // decode and verify relay message
//        byte[][] serializedMsgs = null;
//        Context.println("kwon : verifier.handleRelayMessage");
//        try {
...
//        Context.println("link.getRelays();");
...
//        }
//        Context.println("kwon : getStatus(BMVStatus.class)");
//        BMVStatusDebug status = verifier.getStatus(BMVStatusDebug.class);
...
//        Context.println("kwon : oldDropSequencesLen");
...
//        }
//        putLink(link);
//        Context.println("kwon : dispatch BTPMessages");
