...
printf "\n\nStep 1: Approve BSH to use Bob's funds for $TOKENS_TRANSFER_AMOUNT ETH"
token_approveTransfer "$TOKENS_TRANSFER_AMOUNT"

#Check Bobs's balance before deposit
printf "\n\nStep 2: Alice's ETH balance before BTP Transfer\n"
...
printf "\n\nStep 3: BOB Initiates BTP token transfer of $TOKENS_TRANSFER_AMOUNT ETH to Alice\n"
