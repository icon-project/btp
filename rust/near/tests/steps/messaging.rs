...
pub static RELAY_MESSAGES_ARE_HANDLED: fn(Context) = |context: Context| {
    let response = context.method_responses("handle_relay_message");
...
pub static BMC_SHOULD_THROW_OWNER_LINK_DOES_NOT_EXIST_ERROR_ON_HANDLING_RELAY_MESSAGES: fn(Context) = |context: Context| {
