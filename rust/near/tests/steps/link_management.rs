...
pub static ADDED_LINK_SHOULD_BE_IN_LIST: fn(Context) -> Context = |mut context: Context| {
    ...
    let expected: HashSet<_> = vec![
       "BTPADDRES_OF_THE_LINK_PROVIDED",
    ]
    .into_iter()
    .collect();
...
pub static REMOVED_LINK_SHOULD_NOT_BE_PRESENT: fn(Context) -> Context = |mut context: Context| {
