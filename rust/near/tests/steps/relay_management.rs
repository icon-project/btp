...
pub static ADDED_RELAYS_SHOULD_BE_IN_LIST: fn(Context) -> Context = |mut context: Context| {
...
pub static DELETED_RELAY_SHOULD_NOT_BE_IN_LIST: fn(Context) -> Context = |mut context: Context| {
    let relay = context.method_responses("get_relays");
