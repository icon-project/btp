...
pub static BSH_OWNER_TRIES_TO_REMOVE_NON_EXSISTING_OWNER: fn(Context) -> Context = | mut context: Comntext| {
    BSH_OWNER_INVOKES_REMOVE_OWNER(context)
    .pipe(BSH_OWNER_INVOKES_REMOVE_OWNER)
};
