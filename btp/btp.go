...
import (
	...
	_ "github.com/icon-project/btp/chain/registry"
...
func New(cfg *Config, w wallet.Wallet, l log.Logger) (*BTP, error) {
	...
	case "pra":
		receiver = pra.NewReceiver(cfg.Src.Address, cfg.Dst.Address, cfg.Src.Endpoint, cfg.Src.Options, l, cfg.AbsBaseDir(), cfg.Dst.Endpoint)
	default:
...
func GetReceiver(source, destination chain.BtpAddress, endpoint string, options map[string]interface{}, logger log.Logger) chain.Receiver {
...
func GetSender(source, destination chain.BtpAddress, wallet base.Wallet, endpoint string, options map[string]interface{}, logger log.Logger) chain.Sender {
